...
- Custom 512-byte bootloader (`bootloader.asm`) with INT 13h Extensions (LBA) and CHS fallback disk reads.
- Kernel sector count is generated automatically from `kernel.bin` size at build time.
...
- Generated sector define: `build/kernel_sectors.inc`
